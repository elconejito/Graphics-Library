                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="{{ action('GraphicsController@edit', ['project_id'=>$project->id, 'id'=>$graphic->id]) }}" class="btn btn-default navbar-btn"><span class="glyphicon glyphicon-pencil"></span> graphic</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
